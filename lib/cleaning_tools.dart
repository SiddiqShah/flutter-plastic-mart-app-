...
class CleaningTools extends StatefulWidget {
  const CleaningTools({super.key});

  @override
  State<CleaningTools> createState() => _CleaningToolsState();
}

class _CleaningToolsState extends State<CleaningTools> {
  final List<Map<String, dynamic>> products = [
    {'name': 'Wiper', 'price': 250.0},
    {'name': 'Brush', 'price': 100.0},
    {'name': 'Window cleaner', 'price': 350.0},
    {'name': 'Moop', 'price': 100.0},
    {'name': 'Broom', 'price': 160.0},
    {'name': 'Dustpan', 'price': 200.0},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cleaning Tools'),
