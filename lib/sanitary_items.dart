...
class SanitaryItems extends StatefulWidget {
  const SanitaryItems({super.key});

  @override
  State<SanitaryItems> createState() => _SanitaryItemsState();
}

class _SanitaryItemsState extends State<SanitaryItems> {
  final List<Map<String, dynamic>> products = [
    {'name': 'Tapes', 'price': 120.0},
    {'name': 'Basins', 'price': 80.0},
    {'name': 'Toilets', 'price': 200.0},
    {'name': 'Mirrors', 'price': 150.0},
    {'name': 'Tiles', 'price': 300.0},
    {'name': 'Tanks', 'price': 500.0},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Sanitary Items'),
